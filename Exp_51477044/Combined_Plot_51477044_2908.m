...
% N_obj = 13;
% w_obj = [1;1;1;100;100;0.05;1;1;1;0.05;1;1;1;];
% c_obj = [1;1;1;3;3;3;4;4;4;4;5;6;7;];
% type_obj = [0;5;4;1;2;0;3;3;3;0;3;6;7;];
% s_obj = [px;1.1*px;t_px;[30;10;0;25;35;45;0;25;10/nfrac;15/nfrac;]];
% n_obj = [nan;nan;0.95;nan;nan;nan;...
%     0.5;0.2;0.1;nan;0.1;nan;0.5;];
...
out_folder = "output/";
resd = cell(3,1);
% fnames = {'./output/BED-ADMM-2024-08-30-23-07.mat' ...
%     './output/BED-ADMM-2024-08-31-00-13.mat',...
%     './output/BED-ADMM-2024-08-30-22-01.mat'};
fnames = {'./output/BED-ADMM-2024-08-30-22-01.mat' ...%'./output/BED-ADMM-2024-08-30-22-01.mat' ...
    './output/BED-ADMM-2024-10-12-15-36.mat'};%'./output/BED-ADMM-2024-08-30-23-07.mat'};

% multi-IMPT: 10-12-15-36
% ARC: 08-30-22-01, 10-13-13-06
...
for ff = 1:2
    ...
    % Get output metrics
    [D95, Dmax, CI, BED50_bladder, BED20_bladder, BED50_rectum, BED20_rectum, BED10_rectum,...
        BED10_femhead, BED50_penilebulb] = calcparaBED_51477044(MD, BED2, px, c);
    resd{ff} = [D95, Dmax, CI, BED50_bladder, BED20_bladder, BED50_rectum, BED20_rectum, BED10_rectum,...
...
% legend show
legend(L([2,6,10]), 'Bladder','Rectum','Penilebulb','Location','northeast','FontSize',14)
grid on
...
% xlabel('BED (%)','FontSize',18);
% ylabel('Volume (%)','FontSize',18);
% legend('ARC','multi-IMPT','Conv','Location','northeast','FontSize',14);
% grid on
% %title(strcat('BED DVH in bladder for case ID: ',ptid));
% saveas(gcf,strcat(out_folder,'BEDBladder_2908_',ptid,'.fig'));
% hold off
