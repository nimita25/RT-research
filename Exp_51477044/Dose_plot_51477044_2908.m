...
name1=['./output/BED-ADMM-2024-08-30-22-01.mat']; % ARC
name2=['./output/BED-ADMM-2024-10-12-15-36.mat']; % multi-IMPT
% name1=['./output/BED-ADMM-2024-08-30-23-07.mat']; % NC-BED
% name2=['./output/BED-ADMM-2024-08-31-00-13.mat']; % NC-Dose
% name3=['./output/BED-ADMM-2024-08-30-22-01.mat']; % Conv
