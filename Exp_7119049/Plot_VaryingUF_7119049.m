...
for uf = 1:length(UF_id)
    ...
    if unique_fields == 12
        disp('Loading output...')
        load('./output/BED-ADMM-2024-07-30-18-38.mat')
    elseif unique_fields == 8
        disp('Loading output...')
        load('./output/BED-ADMM-2024-07-30-20-57.mat')
    elseif unique_fields == 6
        disp('Loading output...')
        load('./output/BED-ADMM-2024-07-19-20-15.mat')
    elseif unique_fields == 4
        disp('Loading output...')
        load('./output/BED-ADMM-2024-07-31-07-32.mat')
    elseif unique_fields == 3
        disp('Loading output...')
        load('./output/BED-ADMM-2024-08-01-09-21.mat') 
    elseif unique_fields == 2
        disp('Loading output...')
