...
%load('./output/BED-ADMM-2024-08-23-15-52.mat')
load('./output/BED-ADMM-2024-08-26-14-40.mat')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:n_rho
    ...
    for ll = 1:length(type_constr{i})
        ...
        elseif type_constr{i}(ll) == 3
            ...
            ai = ceil(DVH_perc{i}(DVH_counter));
...
load('./output/BED-ADMM-2024-08-23-19-17.mat')
%load('./output/BED-ADMM-2024-08-26-19-30.mat')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
