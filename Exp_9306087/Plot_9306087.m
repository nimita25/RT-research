...
mu = 1e-2;%0.1; %coefficient of penalty for BED max, BED mean constraint for OAR
mu_max = 1e-2;%0.1; %coefficient of penalty for BED DVH max constraint for OAR
...
%% Load output here
disp('Loading output...')
%load('./output/BED-ADMM-2024-06-26-19-11.mat')
load('./output/BED-ADMM-2024-06-26-14-12.mat')
load('./output/BED-ADMM-2024-06-25-20-56.mat')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
