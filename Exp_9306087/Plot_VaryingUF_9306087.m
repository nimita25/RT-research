...
for uf = 1:length(UF_id)
    ...
    if unique_fields == 12
        disp('Loading output...')
        load('./output/BED-ADMM-2024-07-28-13-28.mat')
    elseif unique_fields == 8
        disp('Loading output...')
        load('./output/BED-ADMM-2024-07-28-14-37.mat')
    elseif unique_fields == 6
        disp('Loading output...')
        load('./output/BED-ADMM-2024-07-15-15-42.mat')
    elseif unique_fields == 4
        disp('Loading output...')
        load('./output/BED-ADMM-2024-07-28-20-20.mat')
    elseif unique_fields == 3
        disp('Loading output...')
        load('./output/BED-ADMM-2024-07-29-07-17.mat')
    elseif unique_fields == 2
        disp('Loading output...')
        load('./output/BED-ADMM-2024-07-30-12-49.mat')
    else
        disp('Loading output...')
...
legend(tmp,'location','northeast','FontSize',10)
%legend('Our method','Conventional');
title(strcat('BED DVH in brainstem: ',ptid));
