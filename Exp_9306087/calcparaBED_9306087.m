function [D95, Dmax, CI, BEDmax_BS, BEDmean_BS, BEDmax_OC, BEDmean_OC,...
...
% Calculate BED constraint values for brainstem.
BED3 = BED2(oar1);
BEDmax_BS = max(BED3);
BEDmean_BS = mean(BED3);

% Calculate BED constraint values for optic chiasm.
BED3 = BED2(oar2);
BEDmax_OC = max(BED3);
BEDmean_OC = mean(BED3);

% Calculate BED constraint values for optic nerve.
BED3 = BED2(oar3);
BEDmax_ON = max(BED3);
BEDmean_ON = mean(BED3);

% Calculate BED constraint values for brain.
BED3 = BED2(oar5);
BEDmax_B = max(BED3);
BEDmean_B = mean(BED3);
