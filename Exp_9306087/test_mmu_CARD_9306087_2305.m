for NNZ = 40:5:40
    ...
    [D95, Dmax, CI, Dmean_oar1, V10_oar1, Dmean_oar2, V10_oar2, Dmean_oar3, Dmean_oar5, Dmean_body] = calcpara_9306087_2308(nfrac, d, px, c);
    ...
    outp.resd = resd;
    outp.mu_min = mu_min;
    fname =strcat('.\Results_', ptid, '\res2308_', ptid, '_NNZ_', int2str(NNZ), '_CARD_', int2str(N_iter), string(datetime('now','Format',"yyyy-MM-dd-HH-mm")), '.mat');
