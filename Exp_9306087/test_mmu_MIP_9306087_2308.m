...
for NNZ = 45:5:50
    ...
    %x_init(1:NNZ) = 1;
    tic; [x0,s,sg] = admm_ip_2308(ip,var_CG,NNZ,x_init); toc; %sg := active energy layers
    ...
    [D95, Dmax, CI, Dmax_oar1, V10_oar1, Dmax_oar2, Dmax_oar3, Dmax_oar4, V12_oar5, Dmean_body] = calcpara_9306087_2308(nfrac, d, px, c);
    ...
    %save(['.\Results_' ptid '\res_2308' ptid '_NNZ_' int2str(NNZ) '_MIP_' int2str(N_iter) '.mat'],'obj_total', 'x', 'x0', 'xp', 'd', 'obj', 'D95', 'Dmax', 'n_gs');
    %save(['.\Results_' ptid '\res_' ptid '_' int2str(NNZ) '_MIP_50_10.mat'],'obj_total', 'x', 'x0', 'xp', 'd', 'obj', 'D95', 'Dmax', 'n_gs');
    % if N_Dij == 1
