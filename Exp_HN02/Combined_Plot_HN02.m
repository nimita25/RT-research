...
disp("Loading data...")
if 0%exist(strcat(out_folder,"Problem_para_" ,ptid,".mat"),"file")
...
%% Load output here
disp('Loading output...')
load('./output/BED-ADMM-2024-08-02-14-41.mat')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% BED DVH for Larynx
nm = 1; %4: Larynx, 3: Oropharynx, 2: OralCavity, 1: R Parotid
...
%% Load output here
disp('Loading output...')
load('./output/BED-ADMM-2024-07-19-12-59.mat')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
legend('Our method','Conventional');
if nm == 4
    title(strcat('BED DVH in Larynx: ',ptid));
elseif nm == 3 
    title(strcat('BED DVH in Oropharynx: ',ptid));
elseif nm == 2 
    title(strcat('BED DVH in OralCavity: ',ptid));
else
    title(strcat('BED DVH in Parotid: ',ptid));
end
