...
out_folder = "output/";
resd = cell(3,1);
% fnames = {'./output/BED-ADMM-2024-09-05-14-20.mat' ...
%     './output/BED-ADMM-2024-09-05-14-27.mat',...
%     './output/BED-ADMM-2024-09-05-14-10.mat'};
% fnames = {'./output/BED-ADMM-2024-10-13-16-23.mat' ...%'./output/BED-ADMM-2024-09-05-14-10.mat' ...
%     './output/BED-ADMM-2024-10-13-15-35.mat'};%'./output/BED-ADMM-2024-09-05-14-20.mat'};
fnames = {'./output/BED-ADMM-2024-10-17-11-00.mat' ...%'./output/BED-ADMM-2024-09-05-14-10.mat' ...
    './output/BED-ADMM-2024-10-17-10-47.mat'};%'./output/BED-ADMM-2024-09-05-14-20.mat'};

%10-12-13-54 -> ARC with dose only
%09-05-14-27 -> multi-IMPT with dose only
%10-12-11-52 -> multi-IMPT with dose for target and BED for OARs
%10-13-15-35 -> multi-IMPT with dose for target and BED for OARs with updated weights (correct one)
%09-05-14-10, 10-13-15-59 -> ARC with dose for target and BED for OARs
...
for ff = 1:numel(fnames)
    ...
    % Get output metrics
    [D95, Dmax, CI, BEDmax_P, BEDmean_P, BEDmax_OC, BEDmean_OC,...
    BEDmax_OP, BEDmean_OP, BEDmax_L, BEDmean_L] = calcparaBED_HN02(MD, BED2, px, c);
    resd{ff} = [D95, Dmax, CI, BEDmax_P, BEDmean_P, BEDmax_OC, BEDmean_OC,...
    BEDmax_OP, BEDmean_OP, BEDmax_L, BEDmean_L];
...
% legend show
legend(L([2,6,10]), 'Oropharynx','OralCavity','Larynx','Location','northeast','FontSize',14)
grid on
...
% grid on
% %title(strcat('BED DVH in Oropharynx for case ID: ',ptid));
% saveas(gcf,strcat(out_folder,'BEDOR_2908_',ptid,'.png'));
% hold off
