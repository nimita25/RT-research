...
%load('Results_HN02\res0602_HN02_4_shifts_1_RND_50_2025-06-02-16-21.mat','d')
%load('Results_HN02\res0602_HN02_4_shifts_4_QC_50_2025-06-05-10-44.mat','d')
load('Results_HN02\res0602_HN02_4_shifts_4_multiQC_50_2025-06-05-11-21.mat','d')
...
d=reshape(d,cubeDim(1), cubeDim(2), []);
d(d>1.199)=1.199;
