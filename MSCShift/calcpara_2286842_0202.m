function [D95, Dmax, CI, Dmean_oar1, V50_oar1, Dmean_oar2, Dmean_oar3, Dmean_oar4, Dmean_oar5, Dmax_oar5, Dmean_oar6, Dmean_oar7, Dmean_body] = calcpara_2286842_0202(nfrac, d, px, c)
...
V50_oar1 = sum(d(oar1) >= 30 / nfrac) / numel(oar1) * 100; % Percent volume receiving at least 30 Gy

Dmean_oar2 = mean(d(oar2));
Dmean_oar3 = mean(d(oar3));
Dmean_oar4 = mean(d(oar4));

Dmean_oar5 = mean(d(oar5));
Dmax_oar5 = max(d(oar5));

Dmean_oar6 = mean(d(oar6));
Dmean_oar7 = mean(d(oar7));
