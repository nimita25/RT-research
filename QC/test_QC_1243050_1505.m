...
%% Tmp code : delete later
% angle1 = [0 0 0 60 60];
% id1 = [150 240 300 105 315];
% indC=nchoosek(1:5,3);
% 
% for indCiter = 1:size(indC,1)
%% Tmp code : delete later
...
if qc <= 1
    ...
    % angle selection for update QC code 
    % angle = [angle1(indC(indCiter,1)) angle1(indC(indCiter,2)) angle1(indC(indCiter,3))]
    % id = [id1(indC(indCiter,1)) id1(indC(indCiter,2)) id1(indC(indCiter,3))]
