...
nm = [3;5];
out_folder = "Results_1243050/";
resd = cell(3,1);

% All OAR
fnames = {'Results_1243050\res0202_1243050_3_NNZ_3_RND_50_2025-03-21-10-04.mat' ...
    'Results_1243050\res0202_1243050_3_NNZ_3_RND_50_2025-03-31-09-52.mat' ...
    'Results_1243050\res0202_1243050_3_NNZ_3_RND_50_2025-03-31-13-15.mat'};
% LB+SB
...
for ff = 1:numel(fnames)
    ...
    nn = 1;
    if ff == 1
    plot(t(1:tid)*100,100*D_O{nn}((1:tid),ff),'LineWidth',2,'Color','red','LineStyle','--');
    elseif ff == 2
        plot(t(1:tid)*100,100*D_O{nn}((1:tid),ff),'LineWidth',2,'Color','blue','LineStyle','--');
    else
        plot(t(1:tid)*100,100*D_O{nn}((1:tid),ff),'LineWidth',2,'Color','green','LineStyle','--');
    end
    nn = 2;
    if ff == 1
    plot(t(1:tid)*100,100*D_O{nn}((1:tid),ff),'LineWidth',2,'Color','red','LineStyle',':');
