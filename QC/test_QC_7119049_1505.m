...
s_obj=[px;px;px*1.1;0;px;
    [18;12;27;20]/nfrac;0;0;];
n_obj=round([nan;n_c(1)*0.95;nan;nan;nan;
    n_c(3)*0.5;n_c(3)*0.3;n_c(4)*0.6;n_c(5)*0.5;nan;nan;nan;]);
c_obj=[1;1;1;2;2;
    3;3;4;5;4;3;];
id_obj = cell(N_obj, 1);
...
tic; [x0,s] = admm_mip_1505(ip,var_CG,NNZ,x_init,qc);  %sg := active beam angles
time_mip = toc;
...
[D95, Dmax, CI, Dmean_oar1, V12_oar1, Dmean_oar2, V27_oar2, Dmean_oar3, Dmean_body] = calcpara_7119049_0202(nfrac, d, px, c);
resd = [D95, Dmax, CI, Dmean_oar1, V12_oar1, Dmean_oar2, V27_oar2, Dmean_oar3, Dmean_body];
