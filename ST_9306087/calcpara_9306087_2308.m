function [D95, Dmax, CI, Dmax_oar1, V10_oar1, Dmax_oar2, Dmax_oar3, Dmax_oar4, V12_oar5, Dmean_oar1, Dmean_body] = calcpara_9306087_2308(nfrac, d, px, c)
...
Dmean_oar1 = mean(d(oar1))/ px * 100;
V10_oar1 = sum(d(oar1) >= 10 / nfrac) / numel(oar1) * 100; % Percent volume receiving at least 10 Gy
