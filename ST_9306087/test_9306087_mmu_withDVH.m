...
px = 1.3119; % prescription dose
nfrac = 60; % number of fraction
mu_min = 0; % MMU threshold
...
[D95, Dmax, CI, Dmax_oar1, V10_oar1, Dmax_oar2, Dmax_oar3, Dmax_oar4, V12_oar5, Dmean_oar1, Dmean_body] = calcpara_9306087_2308(nfrac, d, px, c);
resd = [D95, Dmax, CI, Dmax_oar1, V10_oar1, Dmax_oar2, Dmax_oar3, Dmax_oar4, V12_oar5, Dmean_oar1, Dmean_body];
...
fname = strcat('output/resADMM-',string(datetime('now','Format',"yyyy-MM-dd-HH-mm")),'.mat');
%fname = ['.\output\res_' ptid '_ADMM.mat'];
