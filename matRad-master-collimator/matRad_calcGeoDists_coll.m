function [ix,rot_coordsVdoseGrid_coll, rad_distancesSq, isoLatDistsX,isoLatDistsZ] = ...
          matRad_calcGeoDists_coll(rot_coords_bev, ...
                              sourcePoint_bev, ...
                              targetPoint_bev, ...
                              SAD, ...
                              radDepthIx, ...
...
rot_coordsVdoseGrid_coll = rot_coords_bev(subsetMask, :);
