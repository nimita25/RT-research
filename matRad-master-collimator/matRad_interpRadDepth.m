function radDepthVpoint = matRad_interpRadDepth(ct,mgx,mgy,mgz,ctScenNum,V,DosePoint,radDepthV)
...
coarseRadDepthPoint          = matRad_interp3(mgx,mgy,mgz,radDepthCube,DosePoint(:,1),DosePoint(:,2),DosePoint(:,3));
radDepthVpoint{ctScenNum}  = coarseRadDepthPoint;
