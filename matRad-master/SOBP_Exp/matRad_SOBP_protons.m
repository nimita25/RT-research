...
addpath('D:\work\matRad-master\')
%% Generate Beam Geometry STF
stf = matRad_generateStf_SOBP(ct,cst,pln);
...
dij = matRad_calcParticleDose_SOBP(ct,stf,pln,cst);
...
figure
imagesc(resultGUI.LET(:,:,slice)),colormap(jet),colorbar,title('LET [keV]')
