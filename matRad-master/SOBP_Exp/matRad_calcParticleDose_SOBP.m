function dij = matRad_calcParticleDose_SOBP(ct,stf,pln,cst,calcDoseDirect)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:length(stf) % loop over all beams
    ...
    radDepthV = matRad_rayTracing_SOBP(stf(i),ct,V,rot_coordsV,lateralCutoffRayTracing);
    fprintf('done.\n');
    ...
    fprintf('matRad: calculate lateral cutoff...'); % waht is this?
    cutOffLevel = .995;
