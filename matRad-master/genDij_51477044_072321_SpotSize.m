...
folder='C:\Users\hao\Desktop\SpotSize\51477044_spotsize\';
...
stf = matRad_generateStf_072321(lss,ct,cst_ctv,pln);
% dij = matRad_calcParticleDose(ct,stf,pln,cst);
dij = matRad_calcParticleDose_072321(ct,stf,pln,cst);
save([folder ptid '_' num2str(gantryAngles(i)) '.mat'],'dij','stf','-v7.3');
end
