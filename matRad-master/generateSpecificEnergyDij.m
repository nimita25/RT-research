...
ptid_1='C:\Users\hao\Desktop\Bowen\51426287_33_270620';
...
%%
[dij_cell,stf_cell] = generateMulti_dij(ptid_1,pln,ct,cst_ctv,cst_ptv,machine,Spec_energy,bw,lss,gantryAngles);
...
function [dij_cell,stf_cell] = generateMulti_dij(ptid_1,pln,ct,cst_ctv,cst_ptv,machine,Spec_energy,bw,lss,gantryAngles)
%%
% gantryAngles = 0 : 10 : (N-1)*10;
