...
delta=5;dx=3;
% ptid='51426287'; % (!)
load(['C:\Users\hao\Desktop\FLASH_BL\' ptid '\' ptid '.mat'],'cst','ct');
idctv=[9]; % (!)
...
%         save([ptid_1 '\','51426287_dij_proton_',num2str(bw),num2str(lss),'_Spec_energy_',num2str(i),'.mat'],'dij','-v7.3')
        save(['C:\Users\hao\Desktop\FLASH_joint_v2\' ptid '\' ptid '_dij_',num2str(i),'_v2.mat'],'dij','-v7.3')
    end
end
