function dij = matRad_calcParticleDose_072321(ct,stf,pln,cst,calcDoseDirect)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% machine.meta.LUT_bxWidthminFWHM=[1,Inf;1 1];
% nbp=numel(machine.data);
% for i=1:nbp
%     machine.data(i).initFocus.sigma=[1 1];
%     machine.data(i).sigma=max(machine.data(i).sigma,0);
% end
machine.meta.LUT_bxWidthminFWHM=[0.1,Inf;0.1 0.1];
nbp=numel(machine.data);
for i=1:nbp
    machine.data(i).initFocus.sigma=[0.1 0.1];
    machine.data(i).sigma=max(machine.data(i).sigma-5,0);
end
