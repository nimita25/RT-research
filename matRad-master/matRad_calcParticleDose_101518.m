function dij = matRad_calcParticleDose_101518(shift,ct,stf,pln,cst,calcDoseDirect)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:length(stf) % loop over all beams
    ...
    xCoordsV = xCoordsV_vox(:)*ct.resolution.x-stf(i).isoCenter(1)-shift(1);
    yCoordsV = yCoordsV_vox(:)*ct.resolution.y-stf(i).isoCenter(2)-shift(2);
    zCoordsV = zCoordsV_vox(:)*ct.resolution.z-stf(i).isoCenter(3)-shift(3);
