function stf = matRad_generateStf_072321(lss,ct,cst,pln,visMode)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%             longitudinalSpotSpacing = 1.5; % enforce all entries to be used
            longitudinalSpotSpacing = lss; % enforce all entries to be used
        else
            longitudinalSpotSpacing = lss;   % default value for all other treatment machines
        end
