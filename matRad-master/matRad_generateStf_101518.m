function stf = matRad_generateStf_101518(shift,ct,cst,pln,visMode)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:length(pln.propStf.gantryAngles)
    ...
    % (0,0,0) [mm]
    coordsX = coordsX_vox*ct.resolution.x - pln.propStf.isoCenter(i,1)-shift(1);
    coordsY = coordsY_vox*ct.resolution.y - pln.propStf.isoCenter(i,2)-shift(2);
    coordsZ = coordsZ_vox*ct.resolution.z - pln.propStf.isoCenter(i,3)-shift(3);
