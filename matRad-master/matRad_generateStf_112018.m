function stf = matRad_generateStf_112018(ct,cst,pln,visMode)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%             longitudinalSpotSpacing = 1.5; % enforce all entries to be used
            longitudinalSpotSpacing = 6; % enforce all entries to be used
        else
            longitudinalSpotSpacing = 6;   % default value for all other treatment machines
        end
