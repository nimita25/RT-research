...
px=16;
if 0
load([folder ptid '_px16_K3_mmu10_mup0.1_071621.mat'],'d');
% load([folder ptid '_px16_K3_mmu120_mup0.1_071621.mat'],'d');
% load([folder ptid '_px16_K3_mmu160_mup0.1_mu0.1_mud1_071621.mat'],'d');
...
load([folder ptid '_px16_K3_mmu120_mup0.1_071621.mat'],'d','dr');
% load([folder ptid '_px16_K3_mmu160_mup0.1_mu0.1_mud1_071621.mat'],'d','dr');
