...
clear
pwd='C:\Users\hao\Desktop\FLASH_v2';
ptid='97734172';
folder=[pwd '\' ptid '\'];
...
r=ceil(shift/dx);
% ctv1=cst{9,4}{1};
ctv1=union(union(cst{21,4}{1},cst{22,4}{1}),cst{23,4}{1});
...
px=15;
if 1
load([folder ptid '_px15_K4_mmu10_mup0.1_071621.mat'],'d');
% load([folder ptid '_px15_K4_mmu120_mup0.1_071621.mat'],'d');
% load([folder ptid '_px15_K4_mmu160_mup0.1_mu0.1_mud1_071621.mat'],'d');
...
load([folder ptid '_px15_K4_mmu120_mup0.1_071621.mat'],'d','dr');
% load([folder ptid '_px15_K4_mmu160_mup0.1_mu0.1_mud1_071621.mat'],'d','dr');
