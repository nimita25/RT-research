...
px=12;
if 1
load([folder ptid '_px12_K3_mmu10_mup0.1_080521.mat'],'d','dr');
load([folder ptid '_px12_K3_mmu120_mup0.1_080521.mat'],'d','dr');
% load([folder ptid '_px12_K3_mmu160_mup0.1_080521.mat'],'d','dr');
% load([folder ptid '_px12_K3_mmu160_mup0.1_mu0.001_mud1_080521.mat'],'d','dr');
if 1
d_c=8;
dr_c=40;
dmf=1.5;
