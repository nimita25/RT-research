...
px=20;
if 1
load([folder ptid '_px20_K4_mmu10_mup0.1_080621.mat'],'d','dr');
load([folder ptid '_px20_K4_mmu100_mup0.1_080621.mat'],'d','dr');
% load([folder ptid '_px20_K4_mmu120_mup0.1_080621.mat'],'d','dr');
% load([folder ptid '_px20_K4_mmu160_mup0.1_mu0.1_mud1_080621.mat'],'d','dr');
% load([folder ptid '_px15_K3_mmu120_mup0.1_071621.mat'],'d');
% load([folder ptid '_px15_K3_mmu160_mup0.1_mu0.1_mud1_071621.mat'],'d');
if 0
d_c=8;
dr_c=40;
dmf=1.5;
