...
if 1
% load([folder ptid '_res_021819_hybridpb_0_d.mat'],'d1','d2');
% load([folder ptid '_res_021819v2_hybridpb_0_d.mat'],'d1','d2');
% load([folder ptid '_res_021819_hybridpb_10_d.mat'],'d1','d2');
% load([folder ptid '_res_021819v2_hybridpb_10_d.mat'],'d1','d2');
% load([folder ptid '_res_021819_hybridpb_35_d.mat'],'d1','d2');
load([folder ptid '_res_021819v2_hybridpb_35_d.mat'],'d1','d2');
% tmp=cst([7;9;11;17],:);
% cst=tmp;
% cst=cst([12;21;13;7;],:);
cst=cst([12;7;],:);
