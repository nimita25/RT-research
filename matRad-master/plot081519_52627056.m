...
% load([folder ptid '_res_hybridpb_0_w0.0001_d.mat'],'d1','d2');
% load([folder ptid '_res_hybridpb_0_w0.0005_d.mat'],'d1','d2');
% load([folder ptid '_res_hybridpb_10_w0.0002_d.mat'],'d1','d2');
% load([folder ptid '_res_hybridpb_10_w0.001_d.mat'],'d1','d2');
% load([folder ptid '_res_hybridpb_30_w0.0001_d.mat'],'d1','d2');
load([folder ptid '_res_hybridpb_30_w0.0005_d.mat'],'d1','d2');
% tmp=cst([7;9;11;17],:);
% cst=tmp;
% cst=cst([7;9;11;17],:);
cst=cst([7;9;],:);
