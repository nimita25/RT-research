...
if 0
load([folder '\bw5\14461206_px8_K1_mmu2000_dro0_p95_mup0.1_mu1_pbs012921.mat'],'d');
% load([folder '\bw5\14461206_px6_mmu5_dro0_p98_mup0.1_mu0.1.mat'],'d');
% load([folder '\bw5\14461206_px6_K3_mmu120_dro0_new.mat'],'d');
% load([folder '\bw5\14461206_px6_K3_mmu240_dro1_p98_mup0.1_mu0.1.mat'],'d');
% load([folder '\bw5\14461206_px6_K3_mmu1240_mmu25_p98_s0.1_mup0.1_mu0.01.mat'],'d','d1','d2');
...
cst{1,4}{1}=roi;    
load([folder '\bw5\14461206_px8_K1_mmu2000_dro0_p95_mup0.1_mu1_pbs012921.mat'],'dr');dr=double(dr);
   
% load([folder '\bw5\14461206_px6_mmu5_dro0_p98_mup0.1_mu0.1.mat'],'dr');
% load([folder '\bw5\14461206_px6_K3_mmu120_dro0_new.mat'],'dr');
% load([folder '\bw5\14461206_px6_K3_mmu240_dro1_p98_mup0.1_mu0.1.mat'],'dr');
% load([folder '\bw5\14461206_px6_K3_mmu1240_mmu25_p98_s0.1_mup0.1_mu0.01.mat'],'dr');
