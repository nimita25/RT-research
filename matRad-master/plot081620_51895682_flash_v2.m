...
if 1
load([folder '\bw5\51895682_px6_K3_mmu130_dro0_new.mat'],'d');
load([folder '\bw5\51895682_px6_K3_mmu180_dro1_p98_new.mat'],'d');
...
load([folder '\bw5\51895682_px6_K3_mmu130_dro0_new.mat'],'dr');
load([folder '\bw5\51895682_px6_K3_mmu180_dro1_p98_new.mat'],'dr');
