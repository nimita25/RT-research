...
if 1
% load([folder 'Gmin5_mu0001_n200_lam0_d.mat'],'d');
% load([folder 'Gmin5_mu0001_n200_lam000003_d.mat'],'d');
% load([folder 'Gmin13_mu0001_n200_d.mat'],'d');
% load([folder 'Gmin5_mu0001_n200_lam000006_d.mat'],'d');
load([folder 'proton2_mu0001_n50_d.mat'],'d');
tmp=cst([14;7],:);
cst=tmp;
end

d=interpn(x0,y0,z0,d/1.005,x,y,z);
resultGUI=struct('physicalDose',[]);
resultGUI.physicalDose=d/1.8;
...
% figure;imagesc(resultGUI.physicalDose(:,:,1));colorbar;lim = caxis;caxis([0.0 1.15]*45);set(gca,'FontSize', 18);colormap(jet);
matRadGUI
