...
if 1
load([folder '51477044_bw9_lss3_d.mat'],'d');
% load([folder '51477044_bw7_lss3_2076_d.mat'],'d');
tmp=cst([10],:);
cst=tmp;
end
...
figure;imagesc(resultGUI.physicalDose(:,:,1));colorbar;lim = caxis;caxis([0.5 1.15]);set(gca,'FontSize', 18);
% figure;imagesc(resultGUI.physicalDose(:,:,1));colorbar;lim = caxis;caxis([0.0 1.1]*1);set(gca,'FontSize', 18);
matRadGUI
