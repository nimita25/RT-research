...
if 1
% load([folder '51895682_bw9_lss3_d.mat'],'d');
load([folder '51895682_bw6_lss3_2195_d.mat'],'d');
tmp=cst([13;],:);
cst=tmp;
else
...
matRadGUI
% figure;imagesc(resultGUI.physicalDose(:,:,1));colorbar;lim = caxis;caxis([0.0 1.15]);set(gca,'FontSize', 18);
