...
switch method
    ...
    case {2,3}
        ...
        load([folder 'dij_' ptid '_collimator_beam4_45deg+90_ctc5mm_b3_doseGrid113_45.mat']); 
        Dij1=Dij{1};
        ...
        load([folder 'dij_' ptid '_collimator_beam4_45deg+90_ctc5mm_b3_doseGrid113_315.mat']);
        Dij4=Dij{1};
        Dij={[Dij1,Dij2,Dij3,Dij4]};
        [nY,nX]=size(Dij{1});
    case {4,5}
